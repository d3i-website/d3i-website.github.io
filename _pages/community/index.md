...
{% assign community_pages = site.pages | where_exp: "page", "page.url contains '/community'" | where_exp: "page", "page.url != '/community/'" | sort: "title" %}
...
{% for page in community_pages %}
  <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; border-left: 4px solid #008cba;">
    ...
    {% if page.excerpt %}
      <p>{{ page.excerpt }}</p>
    {% endif %}
  <a href="{{ page.url }}" style="background-color: #008cba; color: white; padding: 8px 16px; border-radius: 5px; text-decoration: none; display: inline-block; margin-top: 10px;">Learn More -></a>
  </div>
