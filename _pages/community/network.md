...
sections:
  - title: "Institutional Network"
    ...
    body: |
      ...
      [Contact us about the institutional network →](mailto:DataDonation@uu.nl?subject=Question%20about%20joining%20the%20institutional%20network){: .section-cta}
    component_title: "Network Members"
    component: institutions-grid

  - title: "PhD Network"
    image: /assets/images/hub/undraw_collaborating_mayd.svg
    image_alt: "Two people collaborating in a professional network."
    image_side: left
    body: |
      ...
      [Join the PhD network →]({{ site.phd_network_signup_url }}){: .section-cta}
---
